...
func (mu *MessageUpdate) check() error {
	if _, ok := mu.mutation.FromID(); mu.mutation.FromCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Message.from"`)
	}
	if _, ok := mu.mutation.MatchID(); mu.mutation.MatchCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Message.match"`)
	}
	return nil
}
...
func (mu *MessageUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec.Node.Schema = mu.schemaConfig.Message
...
func (muo *MessageUpdateOne) check() error {
	if _, ok := muo.mutation.FromID(); muo.mutation.FromCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Message.from"`)
	}
	if _, ok := muo.mutation.MatchID(); muo.mutation.MatchCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Message.match"`)
	}
	return nil
}
...
func (muo *MessageUpdateOne) sqlSave(ctx context.Context) (_node *Message, err error) {
	...
	_spec.Node.Schema = muo.schemaConfig.Message
